    ...
    <div class="container">
      <div class="row">
        <div class="section text-center">
          <h3 class="section-heading text-center">Reservar una Cita</h3>
          <p class="sub-heading text-center">Reservar tu atención el día y la hora que deseas el servicio en nuestro taller, solo ingresa los datos solicitados en el siguiente formulario</p>
        </div>
          ...
          <div class="appointment-block">
            <form id="appointment-form" class="appointment-form" method="post" action="appointment.php">                            
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="vehical-model" id="vehical-model" placeholder="Ingrese modelo del vehículo" required>
                </div>
              </div>
